...
function makeObservable(target, annotations, options) {
  ...
  try {
    if (!annotations) {
      ...
      if ("production" !== "production" && !didDecorate) ;
      return target;
    }
...
export { ObservableMap as O, Reaction as R, reaction as a, action as b, createAtom as c, computed as d, entries as e, getGlobalState as f, getDependencyTree as g, getAtom as h, interceptReads as i, intercept as j, observe as k, getAdministration as l, isObservableArray as m, isComputedProp as n, observable as o, makeObservable as p, runInAction as r, set as s, values as v };
